...
export const UNIVERSITIES: University[] = [
  ...
  },
  {
    ...
    note: 'Across the seven counted subjects DU asks for four at B or better and three at C or better. Its circular scores A at 5, B at 4, C at 3 and a D at nothing. Every unit sets a test, and foreign certificates must clear DU\'s own equivalence process before you may sit it. Year windows apply and move each cycle.',
    departments: [
      dept('Science Unit', 'Science', [], 'Science-stream applicants need 8.0 combined across both levels, 3.5 at each.'),
      dept('Business Studies Unit', 'Business', [], 'Needs 7.5 combined, 3.0 at each level; 8.0 from a science background.'),
      dept('Arts, Law & Social Science Unit', 'Arts', [], 'Needs 7.5 combined, 3.0 at each level.'),
      dept('Fine Arts Unit (Charukala)', 'Arts', [], 'Open to any stream, 6.5 combined, the lowest bar at DU. Test includes a drawing paper.'),
      dept('Institute of Business Administration (IBA)', 'Business',
        [subj('Mathematics', 'o', 'E'), { kind: 'countAtGrade', count: 2, minGrade: 'A' }],
        'Mathematics is compulsory at O Level, at least two of the seven subjects must be grade A, and 3.5 is needed separately at each level.'),
    ],
  },
  {
    id: 'ibaju',
